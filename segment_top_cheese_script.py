    ...
    for img_name in image_names:
        ...
        if first_img:
            ...
            cropped2_image = image[
                crop_ymin_hsv:crop_ymax_hsv, crop_xmin_hsv:crop_xmax_hsv
            ]
            lower_hsv, upper_hsv = get_hsv_range(cropped2_image)

        top_cheese_mask = segment_top_cheese_2e2(
            img_name, image, lower_hsv, upper_hsv, predictor
        )
        top_cheese_mask *= 255
        ...
        cv2.imwrite(
            f"../../data_collection/results/{img_name.split('.')[0]}_result.jpg", result
        )
